  ...
  return (
    <section className="relative bg-white">
      <div className="max-w-[1400px] mx-auto">
        ...
        <section className="mb-[32px] px-[15px] 2xl:px-0">
          <Swiper
            spaceBetween={25}
            slidesPerView={3}
                        ...
                        <div className="px-[13px] pt-[11px]">
                          <div className="flex flex-wrap gap-x-[54px] gap-y-[16px] xl:gap-0 xl:nowrap md:justify-between items-center">
                            <div className="flex items-center gap-1 text-gray-500 text-sm">
                              ...
                              <span className="text-[#686868] text-[14px] font-medium">{article.section_name}</span>
                            </div>
                            <div className="flex items-center gap-1 text-gray-500 text-sm">
                              <svg
                                width="18"
                              ...
                              <span className="text-[#686868] text-[14px] font-medium">{article.published_at}</span>
                            </div>
                            <div className="flex items-center gap-1 text-gray-500 text-sm">
                              <svg
                                width="21"
                              ...
                              <span className="text-[#686868] text-[14px] font-medium">{article.views}</span>
                            </div>
                          </div>
