      ...
      <div className="max-w-[1400px] mx-auto relative z-10">
        <div className="text-center mb-[36px] md:mb-[49px]">
          ...
          <p className="text-[#B1B1B1] text-[14px] md:text-[18px] font-medium max-w-[540px] mx-auto ">
            نقدّم مجموعة من الخدمات المتكاملة التي تغطي كافة احتياجاتك الرقمية، بدءًا من البرمجة، مرورًا بالتسويق،
            ووصولًا إلى دعم العملاء.
          </p>
        </div>
        ...
        <div className="flex items-center justify-center mt-[48px]">
          <button className="bg-[#EDA133] flex items-center justify-center gap-4 hover:bg-[#D1912A] w-[229px] h-[56px] text-white font-bold py-4 px-8 rounded-lg transition-all duration-300 ">
            <span className="text-[16px]">كل الخدمات</span>
