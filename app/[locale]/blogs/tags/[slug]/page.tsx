...
import { BlogsPageByTagsDataApi } from "@/app/utils/Types";
...
export default async function Page({ params }: { params: Promise<{ slug: string }> }) {
  ...
  async function getBlogsPageByTagsData(locale: string): Promise<BlogsPageByTagsDataApi> {
    const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/getArticleByTagId`, {
      method: "POST",
      headers: {
  ...
  // fetch typed data
  const { data } = await getBlogsPageByTagsData(locale);
