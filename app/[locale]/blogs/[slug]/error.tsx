    ...
    <>
      ...
      <div className="w-full bg-white pt-[20px] pb-[64px] md:pb-[100px] md:pt-[36px]  px-6">
        <div className="max-w-[1400px] mx-auto">
          ...
          <img className="w-[200px] h-[169px] md:w-[380px] md:h-[321px]" src="/unavailable-content.svg"
          alt="content not available image" />
            ...
            <div className="flex flex-col items-center gap-2 text-center px-[15px] md:px-0">
              ...
              المحتوى غير متاح مؤقتًا
              </h1>
              <p className="text-[#4A4A4A] text-[14px] font-medium leading-[1.43]">نقوم ببعض التحسينات. شكرًا لصبرك، سنعود
            قريبًا.</p>
            </div>
