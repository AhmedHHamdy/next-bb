...
import { ServicesPageDataType } from "@/app/utils/Types";
            ...
            <div className="w-full flex flex-col lg:flex-row lg:items-start xl:items-center lg:justify-between gap-[80px] xl:gap-[236px]">
              ...
              <section className="flex flex-col xl:flex-row  items-center justify-center gap-[80px] lg:gap-[72px]">
                ...
                {data?.steps && data?.steps?.map((step, index) => {
                  return (
                    <div key={index} className="relative w-full lg:w-full lg:h-[170px] flex flex-col gap-4">
                      <div className="absolute right-[0px] top-[-45px] z-[0] opacity-60">
                        <img src="/01.svg" alt="background art" />
                      </div>
                      <h3 className="text-[24px] font-bold text-black leading-[1] relative z-[10]">{step.title}</h3>
                ...
                {/* <div className="relative w-full lg:w-full lg:h-[170px] flex flex-col gap-4">
                  ...
                  <h3 className="text-[24px] font-bold text-black leading-[1] relative z-[10]">التنفيذ بجودة عالية</h3>
                  <p className="text-[15px] text-[#393939] leading-[1.6] font-medium">
                    بناءً على التحليل الأولي، يبدأ فريقنا المتخصص في تنفيذ المشروع باستخدام أفضل الأدوات والتقنيات
                    المتاحة. نحن ملتزمون بتقديم الحلول بأعلى مستوى من الجودة والابتكار لضمان تلبية جميع متطلباتك.
                  </p>
                </div>
                ...
                <div className="relative w-full lg:w-full lg:h-[170px] flex flex-col gap-4">
                  ...
                  <h3 className="text-[24px] font-bold text-black leading-[1] relative z-[10]">مراقبة وتطوير مستمر</h3>
